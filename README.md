...
Библиотека распространяется свободно для:

- моддеров

- сборок

- некоммерческих проектов (если вы хотите использовать эту библиотеку в коммерческих целях то можете связаться со мной и мы обсудим это.)
